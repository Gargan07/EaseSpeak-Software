...
export default function App() {
  ...
  const startRecording = async () => {
    try {
      ...
      await newRecording.prepareToRecordAsync({
        ...
        android: {
          extension: ".wav", // ✅ Manually specify .wav
          outputFormat: Audio.RECORDING_OPTION_ANDROID_OUTPUT_FORMAT_DEFAULT, // ✅ Correct format
          audioEncoder: Audio.RECORDING_OPTION_ANDROID_AUDIO_ENCODER_DEFAULT, // ✅ Correct encoder
          sampleRate: 16000,
          numberOfChannels: 1,
          bitRate: 128000,
        },
        ios: {
          extension: ".wav",
          outputFormat: Audio.RECORDING_OPTION_IOS_OUTPUT_FORMAT_LINEARPCM, // ✅ Correct format
  ...
  const uploadAudio = async () => {
    ...
    try {
      ...
      setRecordingUri(null); // Reset the path
    } catch (error) {
  ...
  // Delete cached files (but not entire cache directory)
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <Text style={styles.header}>Speech-to-Text App</Text>
